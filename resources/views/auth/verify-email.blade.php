        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-5 d-none d-md-block text-center">
                    <img src="{{ asset('images/undraw_two-factor-authentication_8tds.svg') }}"
                        alt="Email Verification Illustration" class="img-fluid mb-4" style="max-height: 400px;">
                        ...
                        <div class="card-body p-4" style="background-color: #e6f0fa;">
                            ...
                            <div class="mt-4 d-flex flex-column flex-sm-row justify-content-center gap-2">
                                ...
                                <form method="POST" action="{{ route('seller.verification.send') }}"
                                    ...
                                    @csrf
                                    <button type="submit" class="d-block w-100 sm:w-auto px-3 py-2 rounded text-white"
                                        style="background-color: #0d6efd; border: none; transition: background-color 0.3s;">
